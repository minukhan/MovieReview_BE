        ...
        httpSecurity
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/", "/cinewall/auth/id-check", "/cinewall/auth/email-certification", "/cinewall/auth/check-certification", "/cinewall/auth/sign-up", "/cinewall/auth/sign-in",
                                ...
                                "/cinewall/review/detail/*", "/cinewall/review/poster-list/*", "/cinewall/actor/*/recommend", "/cinewall/crew/*/recommend", "/bot/*/chat", "/cinewall/user/*/mypage", "/cinewall/follow/**").permitAll() // 인증 없이 접근 가능
                        .requestMatchers("/cinewall/auth/logout", "/cinewall/movie/favorite", "/cinewall/movie/userbase", "/cinewall/movie/*/reviews", "/cinewall/movie/genre", "/cinewall/recommend/hashtag",
